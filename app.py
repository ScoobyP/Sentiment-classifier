...
def load_sentiment_model():
    pipeline = joblib.load('sentiment_pipeline11.pkl')
    return pipeline
...
if app_mode == 'Sentiment Analysis':
    ...
    with st.expander('Model Limitations'):
        st.write('The above classification model has been trained on a mix of data from - amazon reviews, flight related tweets, IMDB movie reviews and restaurant reviews.\n After extensive datacleaning, preprocessing, vectorizing, hyperparameter tuning and model selection, a classicML algo with certain hyperparameters was  chosen to be the best ML model on this dataset.')
